...
The program in here was sole developed by one software dev; This program is the final product of a 'Senior Capstone Project' that was developed for a Bachelor degree during time in University.
